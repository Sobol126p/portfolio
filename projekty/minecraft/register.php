...
<body onload="wejscie_register()">
    ...
    <container_reg class="reg_pr" id="reg_pr">
        ...
        <div style="position: relative; top: 200px;">
            <form action="functions/reg.php" method="post">
                <div class="grid_reg_form">
                    ...
                    <div></div>
                    <div></div>
                    <div><input type="text" name="login" class="input"></div>
                    <div></div>
                    <div></div>
                    <div class="text_3" style="padding-top: 18px;">Hasło: </div>
                    <div></div>
                    <div></div>
                    <div><input type="password" name="password" class="input"></div>
                    <div></div>
                    <div></div>
                    <div class="text_3" style="padding-top: 18px;">Powtórz hasło: </div>
                    <div></div>
                    <div></div>
                    <div><input type="password" name="password2" class="input"></div>
                    <div></div>
                    <div></div>
                    <div><button type="submit" class="reg_button">ZAREJESTRUJ SIĘ</button></div>
                    <div></div>
                </div>
            </form>
        </div>
        ...
        <div style="position: relative; top: 300px; left:17%;">
            <?php
            if(isset($_GET['text_zwrotny'])){
            echo "<info class='text_3' style='color: red;'>" . $_GET['tekst_zwrotny'];
            ".</info>";
            }
            ?>
        </div>
